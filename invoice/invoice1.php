        ...
        <div class="row">
            <div class="col mt-5">
                <form action="saveInvoice" method="post" id="basicForm">
                    ...
                    <div class="form-row">
                        <div class="col form-group">
                            <input type="search" list="buyersList2" class="form-control" id="buyerName" name="buyerName" value="<?php echo $buyerName; ?>" onchange="myFunction()" placeholder=" " required>
                       ...
                       // Fetch and display buyer names from your data source (replace this with your actual data retrieval logic)
                        ...
                        <div class="col form-group">
                            <input type="text" class="form-control" id="buyerGstin" name="buyerGstin" value="<?php echo $buyerGstin; ?>" value="<?php echo $buyerGstin1; ?>" placeholder=" " required>
                    ...
                    <div class="form-row">
                        <div class="col form-group">
                            <input type="text" class="form-control" id="buyerAddress" name="buyerAddress" value="<?php echo $buyerAddress; ?>" placeholder=" " required>
                            <label for="buyerAddress">Address</label>
                        </div>
                        <div class="col form-group">
                            <input type="text" class="form-control" id="buyerState" name="buyerState" value="<?php echo $buyertState; ?>" placeholder=" " required>
                    ...
                    <div class="form-row">
                        <div class="col form-group">
                            <input type="text" class="form-control" id="transportName" name="transportName" value="<?php echo $transportName; ?>" placeholder=" " required>
                            <label for="transportName">Transport Name</label>
                        </div>
                        <div class="col form-group">
                            <input type="text" class="form-control" id="truckNo" name="truckNo" value="<?php echo $truckNumber; ?>" placeholder=" " required>
                            <label for="truckNo">Truck No</label>
                        </div>
                        <div class="col form-group">
                            <input type="text" class="form-control" id="rr-lr-no" name="rr-lr-no" value="<?php echo $RRLRNO; ?>" placeholder=" " required>
